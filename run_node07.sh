ulimit -n 4096
# tnt
# python train_sdf_depth.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Barn -m outputs/tnt_1111/Barn -r 2 --eval --save_ckpt --use_decoupled_appearance #--ckpt_pth outputs/tnt_1111/Barn/ckpt/ckpt_20000.pth
# python extract_mesh_gsdf.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Barn -m outputs/tnt_1111/Barn -r  --iteration 30000
# python eval_tnt/run.py --dataset-dir eval_tnt/TrainingSet/Barn --traj-path /mnt/workfiles/datasets/tnt/TrainingSet/Barn/Barn_COLMAP_SfM.log --ply-path outputs/tnt_1111/Barn/test/ours_30000/fusion/mesh_binary_search_7.ply
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Barn -m outputs/tnt_1111/Barn --mesh_res 1024 --iteration 30000 --unbounded

# python train_sdf_depth.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Caterpillar -m outputs/tnt_1111/Caterpillar -r 2 --eval --save_ckpt --use_decoupled_appearance
# python extract_mesh_gsdf.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Caterpillar -m outputs/tnt_1111/Caterpillar -r 2 --iteration 30000
# python eval_tnt/run.py --dataset-dir eval_tnt/TrainingSet/Caterpillar --traj-path /mnt/workfiles/datasets/tnt/TrainingSet/Caterpillar/Caterpillar_COLMAP_SfM.log --ply-path outputs/tnt_1111/Caterpillar/test/ours_30000/fusion/mesh_binary_search_7.ply
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Caterpillar -m outputs/tnt_1111/Caterpillar --mesh_res 2048 --iteration 30000 --unbounded

# python train_sdf_depth.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Courthouse -m outputs/tnt_1111/Courthouse -r 2 --eval --save_ckpt --use_decoupled_appearance
# python extract_mesh_gsdf.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Courthouse -m outputs/tnt_1111/Courthouse -r 2 --iteration 30000
# python eval_tnt/run.py --dataset-dir eval_tnt/TrainingSet/Courthouse --traj-path /mnt/workfiles/datasets/tnt/TrainingSet/Courthouse/Courthouse_COLMAP_SfM.log --ply-path outputs/tnt_1111/Courthouse/test/ours_30000/fusion/mesh_binary_search_7.ply
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Courthouse -m outputs/tnt_1111/Courthouse --mesh_res 2048 --iteration 30000 --unbounded

# python train_sdf_depth.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Ignatius -m outputs/tnt_1111/Ignatius -r 2 --eval --save_ckpt --use_decoupled_appearance
# python extract_mesh_gsdf.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Ignatius -m outputs/tnt_1111/Ignatius -r 2 --iteration 30000
# python eval_tnt/run.py --dataset-dir eval_tnt/TrainingSet/Ignatius --traj-path /mnt/workfiles/datasets/tnt/TrainingSet/Ignatius/Ignatius_COLMAP_SfM.log --ply-path outputs/tnt_1111/Ignatius/test/ours_30000/fusion/mesh_binary_search_7.ply
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Ignatius -m outputs/tnt_1111/Ignatius --mesh_res 2048 --iteration 30000 --unbounded

# python train_sdf_depth.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Meetingroom -m outputs/tnt_1111/Meetingroom -r 2 --eval --save_ckpt --use_decoupled_appearance
# python extract_mesh_gsdf.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Meetingroom -m outputs/tnt_1111/Meetingroom -r 2 --iteration 30000
# python eval_tnt/run.py --dataset-dir eval_tnt/TrainingSet/Meetingroom --traj-path /mnt/workfiles/datasets/tnt/TrainingSet/Meetingroom/Meetingroom_COLMAP_SfM.log --ply-path outputs/tnt_1111/Meetingroom/test/ours_30000/fusion/mesh_binary_search_7.ply
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Meetingroom -m outputs/tnt_1111/Meetingroom --mesh_res 2048 --iteration 30000 --unbounded

# python train_sdf_depth.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Truck -m outputs/tnt_1111/Truck -r 2 --eval --save_ckpt --use_decoupled_appearance
# python extract_mesh_gsdf.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Truck -m outputs/tnt_1111/Truck -r 2 --iteration 30000
# python eval_tnt/run.py --dataset-dir eval_tnt/TrainingSet/Truck --traj-path /mnt/workfiles/datasets/tnt/TrainingSet/Truck/Truck_COLMAP_SfM.log --ply-path outputs/tnt_1111/Truck/test/ours_30000/fusion/mesh_binary_search_7.ply
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Truck -m outputs/tnt_1111/Truck --mesh_res 2048 --iteration 30000 --unbounded
...
# python train_sdf_depth.py -s /mnt/workfiles/datasets/360/counter -m outputs/360_new/counter -r 2 --eval --save_ckpt --lambda_depth 0.01 --lambda_normal 0.01
# python render.py -m outputs/360_new/counter --data_device cpu --skip_train
# python metrics.py -m outputs/360_new/counter -r 2
# python extract_mesh_gsdf.py -m outputs/360_new/counter --iteration 30000

# python train_sdf_depth.py -s /mnt/workfiles/datasets/360/kitchen -m outputs/360_new/kitchen -r 2 --eval --save_ckpt --lambda_depth 0.01 --lambda_normal 0.01
# python render.py -m outputs/360_new/kitchen --data_device cpu --skip_train
# python metrics.py -m outputs/360_new/kitchen -r 2
...
# python extract_mesh_gsdf.py -m outputs/360_new/flowers --iteration 30000
...
# python extract_mesh_gsdf.py -m outputs/360_new/treehill --iteration 30000
