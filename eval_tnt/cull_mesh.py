...
def extract_depth_from_mesh(mesh,
    ...
    mesh = trimesh.load("/mnt/workfiles/Gaussian-SDF-Eik/outputs/tnt_1007/Truck/test/ours_30000/fusion/mesh_binary_search_7.ply")
...
if __name__ == "__main__":
    ...
    #  python eval_tnt/cull_mesh.py --traj-path eval_tnt/TrainingSet/Truck/Truck_COLMAP_SfM.log --ply-path outputs/tnt_1007/Truck/test/ours_30000/fusion/mesh_binary_search_7.ply
