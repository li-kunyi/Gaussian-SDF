...
# python extract_mesh_mc.py -s /mnt/workfiles/datasets/tnt/TrainingSet/Barn -m outputs/tnt_1111/Barn --mesh_res 2048 --iteration 30000 --unbounded
...
# python train_sdf_depth.py -s /mnt/workfiles/datasets/360/bicycle -m outputs/360_new/bicycle -i images_4 --eval --save_ckpt --lambda_depth 0.01 --lambda_normal 0.01
