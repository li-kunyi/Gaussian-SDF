...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.depth_normal_from_iter = 5000
        ...
        self.lambda_smooth = 0.0001
        self.lambda_gradient_consistency = 0.0

        self.network = {}
        self.network['use_oneblob'] = True
        self.network['use_color'] = False
        self.network['use_ref'] = False
        ...
        self.network['grid']['hash_size'] = 20
        self.network['grid']['voxel_size'] = 0.01
        self.network['density'] = {}
        self.network['density']['params_init'] = {}
        self.network['density']['beta_min'] = 100.
        self.network['density']['params_init']['beta'] = 0.
        self.network['density']['params_init']['alpha'] = 10.
        ...
        # smooth loss
        self.smooth_sample_point = 32
        self.smooth_voxel_size = 0.1
        # for SDF grid training
        self.n_inner_iter = 1
        self.start_train_sdf = 5_000
